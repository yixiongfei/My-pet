...
- **她会看你的日程**：装了本机「知识库」App 的话，她会读它的日程和到期复习（只读，不改），早上第一次见到你说一句今天的安排，每件事开始前 15 分钟提一句「该开始了」。一句话、不重复、两条之间隔半小时；夜里、她睡着、你不在电脑前（5 分钟没动键鼠）、刚从待机醒来都不说；今天没事就不开口。托盘「今天有什么安排」随时能问，聊天里问「今晚学什么」她也答得上来。
